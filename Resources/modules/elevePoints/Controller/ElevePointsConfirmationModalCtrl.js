...
export default class ElevePointsConfirmationModalCtrl {
  constructor ($uibModalInstance, callback, sessions, pemps, codes, defaultCode, periodeName, firstName, lastName, hasSecond, hasThird, secondName, thirdName) {
  ...
  checkValues () {
    this.sessions.forEach(s => {
      ...
      let defaultRow = {name: `${s['courseTitle']}`, isPoint: true, isPresence: true, isComportement: true}
      let outRow = {name: `${s['courseTitle']}`, isPoint: true, isPresence: true, isComportement: true}
      let truncateRow = {name: `${s['courseTitle']}`, isPoint: true, isPresence: true, isComportement: true}
      const point = this.pemps[s['id']]['point']
      const presence = this.pemps[s['id']]['presence']
      const comportement = this.pemps[s['id']]['comportement']
      ...
      if (point === undefined || point === null) {
        ...
        if (!this.isValidPoint(point, this.pemps[s['id']]['total'])) {
